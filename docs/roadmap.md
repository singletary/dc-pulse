...
- **Completed foundation:** terminal-state watches are never silently deleted. Explicit watches retain a normalized resolved record for 30 days and automatic watches for 7 days before moving to a restorable **Archived** section and leaving routine refresh batches.
...
- **Partially completed:** notification history and the last observed details survive archival, and Places provides **Archive** and **Restore** actions. Add a future explicit-watch preference for 7 days, 30 days, 90 days, or Never plus bounded archive retention after external-beta behavior is understood.
